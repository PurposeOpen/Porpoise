...
describe ContentPagesController do
  describe "#show" do
    it "should redirect to action page if the page received is of type 'ActionPage'" do
      FakeWeb.register_uri :get, "http://testmovement:testmovement@example.com/api/it/movements/testmovement.json",
      ...
      FakeWeb.register_uri :get, "http://testmovement:testmovement@example.com/api/it/movements/testmovement/content_pages/take-the-first-step-endorse-the-five-freedoms.json",
  ...
  describe "GET preview" do
    it "should return preview for action page which are unpublished" do
      ...
      FakeWeb.register_uri :get, "http://testmovement:testmovement@example.com/api/it/movements/testmovement/content_pages/10.json", :body => { :title => "Save the Italian-speaking Turtles!", :content => "Content with email!"}.to_json
      FakeWeb.register_uri :get, "http://testmovement:testmovement@example.com/api/it/movements/testmovement/content_pages/10/preview.json?locale=it",
